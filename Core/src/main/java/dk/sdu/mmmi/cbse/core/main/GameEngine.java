...
public class GameEngine implements ApplicationListener {
    ...
    public void create() {
        ...
        Runner = (Assets.getInstance().getManger().get("assets/images/Runners.png", Texture.class));
        Boss = (Assets.getInstance().getManger().get("assets/images/Boss.png", Texture.class));
        Fatty = (Assets.getInstance().getManger().get("assets/images/Fatties.png", Texture.class));
    ...
    private void drawTextur() {
        for (Entity entity : world.getEntities()) {
            if (entity instanceof IPlayer) {
                ...
                ab.draw(Testplayer, positionPart.getX(), positionPart.getY(), 32.5f, 27.5f, 65, 55, 1.2f, 1.2f, (float) Math.toDegrees(positionPart.getRadians()), 0, 0, 65, 55, false, false);
                ...
                ab.draw(Fatty, positionPart.getX(), positionPart.getY(), 55f, 51f, 111, 103, 1, 1, (float) Math.toDegrees(positionPart.getRadians()), 0, 0, 111, 103, false, false);
                ab.end();
            }
